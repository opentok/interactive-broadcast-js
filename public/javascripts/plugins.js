...
/* Chat Box Minimize */
$(document).ready(function(){
    $(".chat-box-header .chat-name").click(function(){
        $(this).parent().parent().toggleClass('active');
    });
});

/* Fan View - Mobile Chat Box */
$(document).ready(function(){
    $(".btn-chat-pannel, .close-chat-box").click(function(){
        $( ".chat-sidebar" ).slideToggle('normal');
    });
});


/* Show Hidden Chat Boxes */
$(document).ready(function(){
    $(".hidden-boxes .hidden-boxes-header").click(function(){
        $(this).next('.drop-up').fadeToggle('fast');
...
$(document).ready(function(){
    $(".sidepanel-open-button").click(function(){
        ...
        $(".content").toggleClass('sidepanel-active');
