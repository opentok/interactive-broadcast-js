...
var EmbedableWidget = React.createClass({displayName: "EmbedableWidget",
  ...
  render: function() {
    return (
      React.createElement(Frame, {head: 
        React.createElement("link", {type: "text/css", href: "styles.css"})
      }, 
        React.createElement("div", {id: "subscribers"})
      )
    );
  }
});
...
React.render(
  React.createElement(EmbedableWidget, {name: "Embedable"}),
  document.querySelector('#' + window.chatShowData.container)
);
},{"./../common/frame":1,"react":158}],3:[function(require,module,exports){
