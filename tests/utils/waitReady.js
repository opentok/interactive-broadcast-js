...
ElementFinder.prototype.waitReady = function(opt_optStr, optBrowser) {
    var self = this;
    var driverWaitIterations = 0;
    var lastWebdriverError;
    optBrowser = typeof(optBrowser) === 'undefined' ? browser : optBrowser;
