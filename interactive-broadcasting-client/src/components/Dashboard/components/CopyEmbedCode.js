    ...
    return (
      <div className="CopyEmbedCode">
        ...
        <div className={classNames('CopyEmbedCode-button-container', { expanded })}>
          <CopyToClipboard text="11111" onCopy={R.partial(handleCopy, ['Fan code'])} >
            <button className={buttonClass}>Get fan code</button>
          </CopyToClipboard>
          <CopyToClipboard text="222222" onCopy={R.partial(handleCopy, ['Host code'])} >
            <button className={buttonClass}>Get host code</button>
          </CopyToClipboard>
          <CopyToClipboard text="33333" onCopy={R.partial(handleCopy, ['Celebrity code'])} >
